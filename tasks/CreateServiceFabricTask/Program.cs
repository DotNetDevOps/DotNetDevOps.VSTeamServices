...
namespace CreateServiceFabricTask
{
    ...
    {
        public ServiceFabricOptions() : 
            base("CreateServiceFabricTask.cluster.json", typeof(ServiceFabricOptions).Assembly)
        {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        "--certificateThumbprint","89920BB62ADD6E9C8E46E0EF8F59046DCED46AA6",
            //        "--sourceVaultValue","/subscriptions/34f0390d-a47c-4067-9ddd-8bab0abcffed/resourceGroups/pks-devopsdemo-test001/providers/Microsoft.KeyVault/vaults/pks-kv-test001-alwj",
            //        "--certificateUrlValue","https://pks-kv-test001-alwj.vault.azure.net:443/secrets/sfcert/f3976840a4714dca919522f7a3cd28ae",
